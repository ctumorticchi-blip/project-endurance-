...
## M0 — Le coach fonctionne (mandat actif)

Objectif : prouver que le moteur de coaching triathlon adaptatif fonctionne
réellement, de bout en bout, sans montre connectée.
...
| M0.12 | QA + Release Candidate | Scénarios de simulation, QA mobile/accessibilité, déploiement, rapport final |

**Stop gate** : une fois M0.12 réellement terminé (tests exécutés, build
vérifié, scénarios simulés), production d'un rapport final et arrêt pour
évaluation humaine avant toute M1.
